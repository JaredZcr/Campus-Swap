package com.chengrui.st.Handler;

import com.chengrui.st.Exception.ParamException;
...
public class GlobalExceptionHandler {
    ...
    public R DataIntegrityViolationExceptionHandler(DataIntegrityViolationException e) {
        ...
        if (message.contains("sh_favorite") || message.contains("user_id")) {
            return R.fail(ErrorMsg.FAVORITE_EXIT);
        }
        if (message.contains("account_number")) {
            return R.fail(ErrorMsg.ACCOUNT_EXIT);
        }
