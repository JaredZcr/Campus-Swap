...
public class OrderAddressServiceImpl implements OrderAddressService {
    ...
    public boolean updateOrderAddress(OrderAddress orderAddressModel) {
        if (orderAddressModel.getId() == null && orderAddressModel.getOrderId() != null) {
            OrderAddress current = orderAddressMapper.selectByOrderId(orderAddressModel.getOrderId());
            if (current != null) {
                orderAddressModel.setId(current.getId());
            }
        }
        if (orderAddressModel.getId() == null) {
            return false;
        }
