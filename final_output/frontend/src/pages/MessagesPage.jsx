...
export default function MessagesPage() {
  ...
  const handleSend = async () => {
    ...
    setSending(true);
    try {
      const res = await sendMessage({ idleId: activeConv.idleId, content, toUser: activeConv.otherUserId });
      if (res?.code === 200 && res.data) {
        // The backend returns the inserted Message without relations. Patch them for the UI.
        const patched = {
          ...res.data,
          fromU: user,
